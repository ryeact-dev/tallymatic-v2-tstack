...
export default function EventMangersList({
  managers = [],
  onSearchChangeHandler,
  onClearHandler,
  filter,
}: {
  managers: Array<UserWithEventAndCompetitions>
  onClearHandler: () => void
        ...
        case 'event':
          return (
            <div className="flex flex-col">
              {user.event.name ? user.event.name : 'No event'}
            </div>
          )
        case 'isActive':
          return (
  ...
  }, [filter, onSearchChangeHandler, managers.length, hasSearchFilter])
